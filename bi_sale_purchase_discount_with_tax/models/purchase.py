            ...
            if res_config.tax_discount_policy == 'tax':
                ...
                if order.discount_type == 'line':
                    ...
                    if order_line.discount_method == 'fix':
                        ...
                        taxes = order_line.taxes_id._origin.compute_all(price_amount, order_line.order_id.currency_id, 1, product=order_line.product_id, partner=order_line.order_id.partner_shipping_id)
                        ...
                        taxes = order_line.taxes_id._origin.compute_all(**order_line._prepare_compute_all_values())
                    return taxes
                elif order.discount_type == 'global':
                    order.discount_amt_line = 0.00
                    if order.discount_method == 'per':
                        ...
                        if order_line.taxes_id:
                            ...
                            taxes = order_line.taxes_id._origin.compute_all(discount, \
