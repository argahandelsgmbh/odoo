...
class SaleOrderInh(models.Model):
    ...
    total_invoice_amount = fields.Float(compute='compute_the_total_invoices',store=True)
    total_payment = fields.Float(compute='compute_the_total_payment',store=True)
    total_open_amount = fields.Float(compute='compute_the_total_open',store=True)
